...
『color / لي تغير لونك』
『rainbow / الرنبو』
『credits / لعرض نقودك بالبوت』 
『level / لعرض مستواك في البوت』
...
client.on('message' , message => {
	...
	if (message.content.startsWith(prefix + "DevC")) {
	...
	bot.users.get("الايدي حقك هنا").send(
		"\n" + "**" + "● السيرفر :" + "**" +
		"\n" + "**" + "» " + message.guild.name + "**" +
		"\n" + "**" + " ● المرسل : " + "**" +
		"\n" + "**" + "» " + message.author.tag + "**" +
 ...
 **
رابط البوت | https://goo.gl/hMvWup
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discord.gg/uSZ7xFm
 **
`);
  message.author.sendEmbed(embed);
   }
